...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const char* pszTimestamp = "MyCoin 13/Feb/2026 - A New Beginning";
...
public:
    CMainParams() {
        ...
        // DNS seeds for MyCoin network
        // Add your own DNS seeds here when you have nodes running
        vSeeds.clear(); // No seeds yet for new network
